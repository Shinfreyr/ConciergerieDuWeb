...
<!-- Inscription Forms ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
    ...
    <div class="card-deck justify-content-center blanc col-md-8 offset-md-3">
        <form action="index.php?action=inscription&db=ok" id="inscriptionForm" method="post" class="MgHtBs bord-form ">
            ...
            <div class="form-group">
                ...
                <p>
                <input type="text" class="form-control birthForm" name="birthDay" id="birthDay" placeholder="Jour" maxlength="02">
                <input type="text" class="form-control" name="birthMonth" id="birthMonth" placeholder="Mois" maxlength="02">
                <input type="text" class="form-control" name="birthYear" id="birthYear" placeholder="Année" maxlength="04">
