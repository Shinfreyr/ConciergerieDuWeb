...
<div class="row parallax justify-content-center" style="background-image: url('src/Public/images/mains.jpg');">
    <div class="card-deck col-sm-8 text-center MgHtBs blanc borddt" style="background-image: linear-gradient(to right bottom, #1c1918, #1c1918, #1c1918, #37669f, #0c4c8c);">
    ...
    <div class="alert welcome col-12 text-justify blanc" id="up" role="alert">
        ...
        <p class="mb-0">Modifiez et vérifier vos informations enregistrer ! <br />
            ...
            <div class="collapse" id="mailManagement">
                <div class="card card-body">
                    <form action="index.php?action=mailManagement&db=ok" id="inscriptionForm" method="post">
                        ...
                        <button type="submit" class="btn btn-TywebButton">Envoyer</button>
                    </form>
                </div>
            </div>
