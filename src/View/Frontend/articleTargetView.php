...
<div class="row justify-content-center"  >    
    <div class="col-12">
        <h1 class="alert-heading blanc MgHtBs"><i class="fa fa fa-quote-left vuebutton"></i>    Votre Offre Sélectionnée    <i class="fa fa-quote-right vuebutton"></i></h1>
        <div class="dropdown-divider Pttraitb" ></div> 
    </div>   
    <div class="col-12 margeshautetbas justify-content-center aligncard">
          <div class="col-xs-5 col-sm-6"> <!-- bloc de gauche ++++++++++++++++++++++++++++ --> 
                <div class="jumbotron">
                    ...
                    <?php
                        if(isset($_SESSION['conciergerieDuWebId'])) {
                            echo '<p class="mx-auto text-center"><a class="btn btn-TywebButton btn-lg btn-block" href="index.php?action=voucher&idArticle='.htmlspecialchars($result['idArticle']).'&endDate='.htmlspecialchars($result['endDateArticle']).'" role="button">Editer mon Bon de réduction <i class="fa fa-print editbutton"></i></a></p>';
                        }
                        else {
                            echo '<p class="mx-auto text-center"><a class="btn btn-TywebButtonconx btn-lg btn-block" href="#" role="button">Connectez vous pour générer votre bon   <i class="fa fa-user-times vuebutton"></i></a></p>';
                        }        
                    ?>
...
<!-- Jumbotron Seller +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++<i class="fa fa fa-quote-left vuebutton"></i><i class="fa fa fa fa-quote-right vuebutton"></i> -->
            <div class="col-xs-5 col-sm-5"><!-- bloc de droite ++++++++++++++++++++++++++++ -->     
                <div class="jumbotron">
                    ...
                    <p class="mx-auto text-center"><a class="btn btn-TywebButton btn-lg btn-block" href="index.php?action=magazin&idSeller=<?= htmlspecialchars($result['idSeller']) ?>&page=1" role="button">Voir toutes les offres de <?= htmlspecialchars($result['societyNameSeller']) ?> <i class="fa fa-search vuebutton"></i></a></p>
                </div>
            </div>
        </div>
    </div>
